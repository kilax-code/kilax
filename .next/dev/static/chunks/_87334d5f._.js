...
"[project]/app/series/SeriesClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SeriesClient() {
    ...
    const fetchAvailableVJs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SeriesClient.useCallback[fetchAvailableVJs]": async ()=>{
            try {
    ...
    }["SeriesClient.useCallback[fetchAvailableVJs]"], []);
    const loadMoreSeries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SeriesClient.useCallback[loadMoreSeries]": async ()=>{
            ...
            try {
                ...
                setSeries({
                    "SeriesClient.useCallback[loadMoreSeries]": (prev)=>[
                            ...prev,
                            ...seriesData
                        ]
                }["SeriesClient.useCallback[loadMoreSeries]"]);
                setHasMore(more);
                setPage({
                    "SeriesClient.useCallback[loadMoreSeries]": (prev)=>prev + 1
                }["SeriesClient.useCallback[loadMoreSeries]"]);
            } catch (error) {
                console.error('Error fetching series:', error);
            } finally{
    ...
    const handleVJFilter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SeriesClient.useCallback[handleVJFilter]": async (vjId, vjName)=>{
            setLoading(true);
            try {
    ...
    }["SeriesClient.useCallback[handleVJFilter]"], []);
    const performSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SeriesClient.useCallback[performSearch]": async (query)=>{
            if (query.trim()) {
                setLoading(true);
                try {
    ...
    }["SeriesClient.useCallback[performSearch]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SeriesClient.useEffect": ()=>{
            fetchAvailableVJs();
        }
    }["SeriesClient.useEffect"], [
        fetchAvailableVJs
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SeriesClient.useEffect": ()=>{
            const handler = setTimeout({
                "SeriesClient.useEffect.handler": ()=>{
                    if (searchQuery.trim()) {
                        setSelectedVJ("");
                        setSelectedVJName("");
            ...
            }["SeriesClient.useEffect.handler"], 400);
            return ({
                "SeriesClient.useEffect": ()=>clearTimeout(handler)
            })["SeriesClient.useEffect"];
        }
    }["SeriesClient.useEffect"], [
        searchQuery,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SeriesClient.useEffect": ()=>{
            const observer = new IntersectionObserver({
                "SeriesClient.useEffect": (entries)=>{
...
_s(SeriesClient, "VAsThWHiMbbZqz1t8pNu9/XYQ80=");
_c = SeriesClient;
var _c;
__turbopack_context__.k.register(_c, "SeriesClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_87334d5f._.js.map