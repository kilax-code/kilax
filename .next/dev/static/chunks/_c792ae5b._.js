...
function MoviesPage() {
    ...
    const fetchAvailableVJs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoviesPage.useCallback[fetchAvailableVJs]": async ()=>{
            try {
    ...
    }["MoviesPage.useCallback[fetchAvailableVJs]"], []);
    const loadMoreMovies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoviesPage.useCallback[loadMoreMovies]": async ()=>{
            if (loading || !hasMore || searchQuery || selectedVJ) return;
            setLoading(true);
            try {
                const { data: moviesData, hasMore: more } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMoviesClient"])(page, 50);
                setMovies({
                    "MoviesPage.useCallback[loadMoreMovies]": (prev)=>[
                            ...prev,
                            ...moviesData
                        ]
                }["MoviesPage.useCallback[loadMoreMovies]"]);
                setHasMore(more);
                setPage({
                    "MoviesPage.useCallback[loadMoreMovies]": (prev)=>prev + 1
                }["MoviesPage.useCallback[loadMoreMovies]"]);
            } catch (error) {
                console.error('Error fetching movies:', error);
            } finally{
    ...
    const handleVJFilter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoviesPage.useCallback[handleVJFilter]": async (vjId, vjName)=>{
            setLoading(true);
            try {
                const filteredMovies = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMoviesByVJClient"])(vjId, vjName);
    ...
    }["MoviesPage.useCallback[handleVJFilter]"], []);
    const performSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MoviesPage.useCallback[performSearch]": async (query)=>{
            if (query.trim()) {
                setLoading(true);
                try {
                    const searchResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["searchMoviesClient"])(query);
    ...
    }["MoviesPage.useCallback[performSearch]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MoviesPage.useEffect": ()=>{
            ...
            }["MoviesPage.useEffect.handler"], 400);
            return ({
                "MoviesPage.useEffect": ()=>clearTimeout(handler)
            })["MoviesPage.useEffect"];
        }
    }["MoviesPage.useEffect"], [
        searchQuery,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-6",
                    children: (searchQuery || selectedVJ) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                !loading && (searchQuery || selectedVJ) && movies.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MoviesPage, "TTlszM7ZidSDU+sA2oaddew3sGw=");
_c = MoviesPage;
var _c;
...
//# sourceMappingURL=_c792ae5b._.js.map